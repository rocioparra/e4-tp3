...
\newcommand{\datapath}{data/ma-overmodulation.txt}
...
\begin{tikzpicture} % [trim axis right]
	...
	\begin{axis} [
		...
		\addplot table [smooth, x=time, y={V(ctrla)}, each nth point=10] {data/ma-overmodulation.txt};
		\addplot table [smooth, x=time, y={V(tri)}] {data/ma-overmodulation-V(tri).ds.txt};
	...
	\begin{axis} [
		...
		\addplot table [smooth, x=time, y={V(a)}] {data/ma-overmodulation-V(a).ds.txt};
	\end{axis}
	...
	\begin{axis} [
		...
		\addplot table [x=time, y={V(A,B)}] {data/ma-overmodulation-V(A,B).ds.txt};
	\end{axis}	
