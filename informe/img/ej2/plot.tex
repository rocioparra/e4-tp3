...
\newcommand{\datapath}{data/data.txt}
...
\begin{tikzpicture} % [trim axis right]
	...
	\begin{axis} [
		...
		\addplot table [smooth, x=time, y={V(ctrla)}, each nth point=1] {data/data-V(ctrla).ds.txt};
		\addplot table [smooth, x=time, y={V(tri)}] {data/data-V(tri).ds.txt};
	...
	\begin{axis} [
		...
		\addplot table [smooth, x=time, y={V(a)}] {data/data-V(a).ds.txt};
	\end{axis}
	...
	\begin{axis} [
		...
		\addplot table [x=time, y={V(A,B)}] {data/data-V(A,B).ds.txt};
	\end{axis}	
